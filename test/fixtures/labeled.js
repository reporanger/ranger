module.exports = ({
  ...
  payload: {
    action: action,
    [threadType]: {
      url: 'https://api.github.com/repos/reporanger/test-issue-bot/issues/7',
      repository_url: 'https://api.github.com/repos/reporanger/test-issue-bot',
      labels_url: 'https://api.github.com/repos/reporanger/test-issue-bot/issues/7/labels{/name}',
      comments_url: 'https://api.github.com/repos/reporanger/test-issue-bot/issues/7/comments',
      events_url: 'https://api.github.com/repos/reporanger/test-issue-bot/issues/7/events',
      html_url: 'https://github.com/reporanger/test-issue-bot/issues/7',
      id: 316635441,
      number,
      title: 'Delete',
      user: {
